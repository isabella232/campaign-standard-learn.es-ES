...
En esta parte, propagaremos el mensaje recibido de Adobe Campaign usando [!DNL Android Notification Manager]. [!DNL Notification manager] se utiliza para notificar al usuario los eventos que se producen.
